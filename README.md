...
Actually schemasaurus is 4th one by speed, it 6x times slower than winner [is-my-json-valid](https://github.com/mafintosh/is-my-json-valid). But speed is not the main advantage of schemasaurus.
